                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Nouveau employé</h3></div>
                                    <div class="card-body">
                                        <form method="POST" action="./config/actions.php" name="addpersonnel">
                                        <div class="row mb-3">
                                                <div class="col-md-6">
                                            ...
                                            <div class="form-floating mb-3">
                                                   ...
                                                   <select class="form-control" id="typerisquenow" name="typerisquenow" required/>
                                                        <label for="typerisquenow">Selectionné type risque</label>
                                            ...
                                            <div style="display:none;" class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" type="text" id="role" name="role" value="<?php echo $_GET['role']?>" required>
                                                </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mt-4 mb-0">
                                                <center>
                                            <input type="submit" value="Ajouter" name="addpersonnel" class="btn btn-success btn-block"></input>
</center>
                                            </div>
                                        </form>
                                    </div>
