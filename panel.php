                    ...
                    <div class="container-fluid px-4">
                        ...
                        <?php if($_SESSION['ROLE'] == '1' ){ ?>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="personnels.php">V Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card mb-4" id="listeprojet">
                            <div class="card-header">
                                ...
                                Liste des projets
                                <?php if($_SESSION['ROLE'] == '1' ){?>
                                <div style="float:right"><a href="./ajouterprojet.php"><button style="color:white" type="button" class="btn btn-success">Ajouter Projet</button></a></div>
                          <?php }; ?>
                            </div>
                            <div class="card-body">
