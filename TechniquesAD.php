            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <h1 class="mt-4">Les risques techniques</h1>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Nombre des projets avec taches techniques : <?php echo countprojectsbytype($_SESSION['ROLE'],1); ?></div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">Nombre des tâches critiques: <?php echo nombretachecritiquebytype($_SESSION['ROLE'],1); ?></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body">Nombre de personnel avec tache technique: <?php echo nombrepersonnelbytype($_SESSION['ROLE'],1); ?></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="#risk">Voir les statistiques</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body"><?php echo nommanager(1); ?></div>
                                </div>
                            </div><?php } ?>
                        </div>
...
?>
                        ...
                        <div class="row" id="risk">
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="card-body"><canvas id="myTacheChartTechnique" width="100%" height="40"></canvas></div>
                                </div>
                            </div>
                        </div>
                    </div>
