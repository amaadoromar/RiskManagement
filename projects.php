                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Nombre des projets actifs : <?php echo countprojectsbytype($_SESSION['ROLE'],$_SESSION['idrisque']); ?></div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">Nombre des risques critiques: <?php echo nombretachecritiquebytype($_SESSION['ROLE'],$_SESSION['idrisque']); ?></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body">Nombre de personnel avec tache active: <?php echo nombrepersonnelbytype($_SESSION['ROLE'],$_SESSION['idrisque']); ?></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="#risk">Voir les statistiques</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body"><?php echo nommanager($_SESSION['idrisque']); ?></div>
                                </div>
                            </div>
                        </div>
...
showprojectsparrisque($_SESSION['idrisque']);
